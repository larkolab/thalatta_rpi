...
print "**** waiting for IP connexion... ****"
time.sleep(20)
print "**** Sending email ****"

# Change to your own account information
# Account Information
to = 'mick.coracin@gmail.com' # Email to send to.
gmail_user = 'thalatta.lora@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'lorawireless' # Gmail password.
